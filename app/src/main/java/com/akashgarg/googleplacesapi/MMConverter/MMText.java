...
public class MMText {
    ...
    public static String processText(String original_text, int EncodedText, boolean SamsungSafe, boolean SyllabelBreak) {
        switch (EncodedText) {
            case TEXT_UNICODE:
